  ...
  return (
    <input
      ...
      className={cn(
        ...
        // Focus
        'focus-visible:border-blue-4 focus-visible:ring-2 focus-visible:ring-blue-4 focus-visible:ring-offset-0 dark:focus-visible:border-blue-6 dark:focus-visible:ring-blue-6',
        // Validated (error, unfocused)
        "[&[aria-invalid='true']]:border-red-9 dark:[&[aria-invalid='true']]:border-red-2",
        // Validated + focused
