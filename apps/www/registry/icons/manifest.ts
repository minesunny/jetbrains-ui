...
export const slugIndex: Record<string, IconPathname[]> = {
  ...
  'access-method': ['database/access-method'],
  ...
  'adapter-script': ['database/adapter-script'],
  ...
  'check-constraint': ['database/check-constraint'],
  ...
  'collection-key': ['database/collection-key'],
  'collection-type': ['database/collection-type'],
  'color-picker': ['editor-icons/color-picker'],
  colors: ['editor-icons/colors'],
  column: ['database/column'],
  'column-blue-key': ['database/column-blue-key'],
  'column-blue-key-dot': ['database/column-blue-key-dot'],
  'column-blue-key-dot-index': ['database/column-blue-key-dot-index'],
  'column-blue-key-index': ['database/column-blue-key-index'],
  'column-dot': ['database/column-dot'],
  'column-dot-index': ['database/column-dot-index'],
  'column-filter': ['database/column-filter'],
  'column-gold-blue-key': ['database/column-gold-blue-key'],
  'column-gold-blue-key-dot': ['database/column-gold-blue-key-dot'],
  'column-gold-blue-key-dot-index': ['database/column-gold-blue-key-dot-index'],
  'column-gold-blue-key-index': ['database/column-gold-blue-key-index'],
  'column-gold-key': ['database/column-gold-key'],
  'column-gold-key-dot': ['database/column-gold-key-dot'],
  'column-gold-key-dot-index': ['database/column-gold-key-dot-index'],
  'column-gold-key-index': ['database/column-gold-key-index'],
  'column-grey-key': ['database/column-grey-key'],
  'column-index': ['database/column-index'],
  comment: ['vcs/comment'],
  ...
  commit: ['database/commit', 'general/tool-windows/commit', 'vcs/commit'],
  ...
  'console-run': ['database/console-run'],
  'console-show-plan': ['database/console-show-plan'],
  ...
  'data-file': ['database/data-file'],
  'data-schema': ['database/data-schema', 'editor-icons/data-schema'],
  'data-share': ['database/data-share'],
  'data-structure': ['database/data-structure'],
  'data-structure-key': ['database/data-structure-key'],
  'data-tables': ['nodes/data-tables'],
  database: ['database/database'],
  'database-changes': ['general/tool-windows/database-changes'],
  'database-external': ['database/database-external'],
  'database-link': ['database/database-link'],
  'database-objects-group': ['database/database-objects-group'],
  ...
  db2: ['database/db2'],
  dbms: ['editor-icons/dbms', 'general/tool-windows/dbms'],
  'ddl-data-source-overlay': ['database/ddl-data-source-overlay'],
  'ddl-dbms': ['database/ddl-dbms'],
  debug: ['general/tool-windows/debug', 'run/debug'],
  'default-constraint': ['database/default-constraint'],
  ...
  'external-link': ['general/general/external-link'],
  'external-schema': ['database/external-schema'],
  ...
  fetch: ['vcs/fetch'],
  field: ['nodes/field'],
  'file-format': ['database/file-format'],
  ...
  'foreign-datawrapper': ['database/foreign-datawrapper'],
  'foreign-partion-table': ['database/foreign-partion-table'],
  'foreign-server': ['database/foreign-server'],
  'foreign-table': ['database/foreign-table'],
  frame: ['debugger/frame'],
  freemaker: ['file-types/freemaker'],
  function: ['database/function', 'nodes/function'],
  'function-external': ['database/function-external'],
  'function-run': ['database/function-run'],
  ...
  'go-to-table': ['database/go-to-table'],
  'gold-key': ['database/gold-key'],
  ...
  h2: ['database/h2'],
  hana: ['database/hana'],
  'hash-cluster': ['database/hash-cluster'],
  'hash-table': ['database/hash-table'],
  'hash-table-key': ['database/hash-table-key'],
  ...
  'index-cluster': ['database/index-cluster'],
  'index-fun': ['database/index-fun'],
  'index-fun-unique': ['database/index-fun-unique'],
  'index-icon': ['database/index-icon'],
  'index-unique': ['database/index-unique'],
  ...
  'json-document': ['database/json-document'],
  'json-document-key': ['database/json-document-key'],
  ...
  'kill-data-source-process': ['database/kill-data-source-process'],
  ...
  'level-auto': ['database/level-auto'],
  'level-one-declared': ['database/level-one-declared'],
  'level-one-details': ['database/level-one-details'],
  'level-one-inherited': ['database/level-one-inherited'],
  'level-three-declared': ['database/level-three-declared'],
  'level-three-details': ['database/level-three-details'],
  'level-three-inherited': ['database/level-three-inherited'],
  'level-two-declared': ['database/level-two-declared'],
  'level-two-details': ['database/level-two-details'],
  'level-two-inherited': ['database/level-two-inherited'],
  ...
  locked: ['database/locked', 'general/general/locked'],
  ...
  'manage-data-sources': ['database/manage-data-sources'],
  manifest: ['file-types/manifest'],
  mariadb: ['database/mariadb'],
  markdown: ['file-types/markdown'],
  'match-case': ['general/inline/match-case'],
  'materialized-log': ['database/materialized-log'],
  'materialized-view': ['database/materialized-view'],
  ...
  'mongo-field': ['database/mongo-field'],
  'mongo-field-gold-key': ['database/mongo-field-gold-key'],
  ...
  'object-group': ['database/object-group'],
  'object-type-attribute': ['database/object-type-attribute'],
  ...
  'operator-class': ['database/operator-class'],
  'operator-family': ['database/operator-family'],
  ...
  package: ['database/package', 'nodes/package'],
  ...
  'partion-table': ['database/partion-table'],
  ...
  'play-back': ['general/actions/play-back'],
  'play-first': ['general/actions/play-first'],
  'play-forward': ['general/actions/play-forward'],
  'play-last': ['general/actions/play-last'],
  ...
  'preview-changes': ['database/preview-changes'],
  ...
  'procedure-group': ['database/procedure-group'],
  'procedure-run': ['database/procedure-run'],
  ...
  'refresh-materialized-view': ['database/refresh-materialized-view'],
  ...
  'run-database-script': ['database/run-database-script'],
  ...
  server: ['nodes/server'],
  'server-objects-group': ['database/server-objects-group'],
  services: ['general/tool-windows/services'],
  servlet: ['nodes/servlet'],
  set: ['database/set'],
  'set-key': ['database/set-key'],
  ...
  'sorted-set': ['database/sorted-set'],
  'sorted-set-key': ['database/sorted-set-key'],
  ...
  sql: ['file-types/sql'],
  'sql-group-by-type': ['database/sql-group-by-type'],
  'sql-other-statement': ['database/sql-other-statement'],
  'sql-select-statement': ['database/sql-select-statement'],
  'sql-server': ['database/sql-server'],
  'sqldml-statement': ['database/sqldml-statement'],
  ...
  'stream-key': ['database/stream-key'],
  'strike-through': ['general/editor/strike-through'],
  string: ['database/string'],
  'string-key': ['database/string-key'],
  structure: ['general/tool-windows/structure'],
  'submit-db': ['database/submit-db'],
  ...
  table: ['database/table', 'general/editor/table'],
  'table-heatmap': ['database/table-heatmap'],
  'table-mapping': ['database/table-mapping'],
  ...
  'text-auto-generate': ['database/text-auto-generate'],
  ...
  type: ['nodes/type'],
  'udf-script': ['database/udf-script'],
  ...
  'unspecified-cluster': ['database/unspecified-cluster'],
  ...
  user: ['database/user'],
  'user-driver': ['database/user-driver'],
  'user-group': ['database/user-group'],
  'user-mapping': ['database/user-mapping'],
  ...
  'view-parameters': ['database/view-parameters'],
  'virtual-column': ['database/virtual-column'],
  'virtual-folder': ['database/virtual-folder'],
  'virtual-key': ['database/virtual-key'],
  'virtual-view': ['database/virtual-view'],
