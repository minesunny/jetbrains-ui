...
export type InlaySecuredShieldProps = Omit<ComponentProps<'svg'>, 'size'> & {
  size?: 12 | 14 | 16 | 20 | 24;
  mode?: 'light' | 'dark';
};

const InlaySecuredShieldLight: FC<
...
const InlaySecuredShieldDark: FC<
  Omit<ComponentProps<'svg'>, 'size'> & { size: number }
> = ({
  size,
  className,
...
export const InlaySecuredShield: FC<InlaySecuredShieldProps> = ({
  size = 16,
  mode = 'light',
  className,
  'aria-label': ariaLabel,
  ...
  const SvgComponent =
    mode === 'light' ? InlaySecuredShieldLight : InlaySecuredShieldDark;
