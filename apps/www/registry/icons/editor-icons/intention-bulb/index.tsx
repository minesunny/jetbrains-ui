...
export type IntentionBulbProps = Omit<ComponentProps<'svg'>, 'size'> & {
  size?: 12 | 14 | 16 | 20 | 24;
  mode?: 'light' | 'dark';
};

const IntentionBulbLight: FC<
...
export const IntentionBulb: FC<IntentionBulbProps> = ({
  size = 16,
  mode = 'light',
  className,
  'aria-label': ariaLabel,
  ...
  const SvgComponent =
    mode === 'light' ? IntentionBulbLight : IntentionBulbDark;
