...
export const Junit = ({
  ...
  >
    <path
      ...
      strokeLinecap="round"
      className="fill-[#FFF7F7] stroke-[#DB3B4B] dark:hidden"
    />
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      ...
      strokeLinecap="round"
      className="fill-[#F2FCF3] stroke-[#208A3C] dark:hidden"
    />
    <path
      d="M1.385 8.42a.6.6 0 0 1 0-.81l4.071-4.466a.6.6 0 0 1 1.044.404v8.91a.6.6 0 0 1-1.042.405z"
      className="fill-[#5E3838] stroke-[#DB5C5C] hidden dark:block"
    />
    <path
      d="M14.628 7.595a.6.6 0 0 1 0 .81l-4.086 4.458a.6.6 0 0 1-1.042-.406V3.543a.6.6 0 0 1 1.043-.406z"
      className="fill-[#375239] stroke-[#57965C] hidden dark:block"
    />
  </svg>
);
