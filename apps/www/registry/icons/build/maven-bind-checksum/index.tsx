...
export const MavenBindChecksum = ({
  ...
  <svg
    ...
    {...props}
  >
    <path d="M15.224 6.499c.358-1.563 0-3.298-2.062-3.298-1.577 0-2.539.588-3.677 1.561-.198-.867-.802-1.53-2.036-1.556-1.265-.07-2.372.46-3.321 1.207.1-.453-.113-.926-.629-1.03-.454-.093-.9.183-.996.616L1.775 7.26a3 3 0 0 1 1.766-.212l.197-.882.002-.003v.007c.71-.995 1.982-1.541 2.91-1.442.78.097 1.317.647 1.055 1.766l-.988 4.478.016.027h1.159a4 4 0 0 1 .164-.175l.556-.556.915-4.102c1.312-1.84 4.547-2.147 3.977.332l-.11.501c.56.003 1.12.135 1.632.397z" className="fill-[#3574F0] dark:fill-[#548AF7]" />
    <path d="M1 12H5V15H1z" className="fill-[#EBECF0] dark:fill-[#43454A]" />
    <path fillRule="evenodd" clipRule="evenodd" d="M5 11v-1a2 2 0 1 0-4 0v1a1 1 0 0 0-1 1v3a1 1 0 0 0 1 1h4a1 1 0 0 0 1-1v-3a1 1 0 0 0-1-1m-3-1a1 1 0 0 1 2 0v1H2zm-1 5v-3h4v3z" className="fill-[#6C707E] dark:fill-[#CED0D6]" />
