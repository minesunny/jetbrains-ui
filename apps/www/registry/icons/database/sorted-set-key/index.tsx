...
export type SortedSetKeyProps = Omit<ComponentProps<'svg'>, 'size'> & {
  size?: 12 | 14 | 16 | 20 | 24;
  mode?: 'light' | 'dark';
};

export const SortedSetKey = ({
  size = 16,
  mode: _mode,
  className,
