...
export type LevelTwoDetailsProps = Omit<ComponentProps<'svg'>, 'size'> & {
  size?: 12 | 14 | 16 | 20 | 24;
  mode?: 'light' | 'dark';
};

export const LevelTwoDetails = ({
  size = 16,
  mode: _mode,
  className,
  'aria-label': ariaLabel,
  ...props
}: LevelTwoDetailsProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 16 16"
  ...
  >
    <path
      ...
      className="fill-[#F9D2B6] dark:fill-[#614438]"
    />
    <path
    ...
    />
    <path d="M8 7.5H12" className="stroke-[#E66D17] dark:stroke-[#C77D55]" />
  </svg>
);
