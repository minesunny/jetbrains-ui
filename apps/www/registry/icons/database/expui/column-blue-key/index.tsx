...
export type ColumnBlueKeyProps = SvgProps;

const ColumnBlueKeyLight: FC<SvgProps> = ({
  size,
  className,
  role,
...
const ColumnBlueKeyDark: FC<SvgProps> = ({
  size,
  className,
  role,
  'aria-label': ariaLabel,
  ...
  <svg
    ...
    aria-hidden={ariaHidden}
  >
    <g clipPath="url(#clip0_1901_31707)">
      <path
        d="M2 4C2 3.44772 2.44772 3 3 3H5V13H3C2.44772 13 2 12.5523 2 12V4Z"
        fill="#43454A"
      />
...
export const ColumnBlueKey: FC<ColumnBlueKeyProps> = ({
  size = 'md',
  mode = 'light',
  className,
  'aria-label': ariaLabel,
  ...
  const SvgComponent =
    mode === 'light' ? ColumnBlueKeyLight : ColumnBlueKeyDark;
