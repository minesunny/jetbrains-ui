...
export type LevelTwoInheritedProps = Omit<ComponentProps<'svg'>, 'size'> & {
  size?: 12 | 14 | 16 | 20 | 24;
  mode?: 'light' | 'dark';
};

export const LevelTwoInherited = ({
  size = 16,
  mode: _mode,
  className,
  'aria-label': ariaLabel,
  ...props
}: LevelTwoInheritedProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 16 16"
  ...
  >
    ...
    />
    <path d="M8 7.5H12" className="stroke-[#6C707E] dark:stroke-[#CED0D6]" />
  </svg>
);

export default LevelTwoInherited;
