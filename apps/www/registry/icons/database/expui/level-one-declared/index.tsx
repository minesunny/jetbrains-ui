...
export type LevelOneDeclaredProps = Omit<ComponentProps<'svg'>, 'size'> & {
  size?: 12 | 14 | 16 | 20 | 24;
  mode?: 'light' | 'dark';
};

export const LevelOneDeclared = ({
  size = 16,
  mode: _mode,
  className,
  'aria-label': ariaLabel,
  ...props
}: LevelOneDeclaredProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 16 16"
  ...
  >
    <path
      ...
      className="fill-[#B7CEFA] dark:fill-[#35538F]"
    />
    <path
    ...
    />
    <path d="M8 11.5H12" className="stroke-[#3574F0] dark:stroke-[#548AF7]" />
  </svg>
);
