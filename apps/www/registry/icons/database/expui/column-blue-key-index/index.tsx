...
export type ColumnBlueKeyIndexProps = Omit<ComponentProps<'svg'>, 'size'> & {
  size?: 12 | 14 | 16 | 20 | 24;
  mode?: 'light' | 'dark';
};

const ColumnBlueKeyIndexLight: FC<
...
> = ({
  ...
  >
    ...
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M6 14H3C1.89543 14 1 13.1046 1 12V4C1 2.89543 1.89543 2 3 2H6V14ZM5 3H3C2.44772 3 2 3.44772 2 4V12C2 12.5523 2.44772 13 3 13H5V3Z"
      fill="#3574F0"
    />
    <path
      fillRule="evenodd"
...
const ColumnBlueKeyIndexDark: FC<
  Omit<ComponentProps<'svg'>, 'size'> & { size: number }
> = ({
  size,
  className,
  ...
  <svg
    ...
    aria-hidden={ariaHidden}
  >
    <g clipPath="url(#clip0_6089_49501)">
      <path
        d="M2 4C2 3.44772 2.44772 3 3 3H5V13H3C2.44772 13 2 12.5523 2 12V4Z"
        fill="#25324D"
      />
...
export default ColumnBlueKeyIndex;
