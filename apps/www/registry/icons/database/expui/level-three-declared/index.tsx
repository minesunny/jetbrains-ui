...
export const LevelThreeDeclared = ({
  size = 16,
  className,
  ...
  >
    <path
      d="M8 4C8 3.44772 8.44772 3 9 3H11C11.5523 3 12 3.44772 12 4V12C12 12.5523 11.5523 13 11 13H9C8.44772 13 8 12.5523 8 12L8 4Z"
      className="fill-[#B7CEFA] dark:hidden"
    />
    <path
      ...
      className="stroke-[#3574F0] dark:hidden"
    />
    <path
      d="M8 4C8 3.44772 8.44772 3 9 3H11C11.5523 3 12 3.44772 12 4V12C12 12.5523 11.5523 13 11 13H9C8.44772 13 8 12.5523 8 12L8 4Z"
      className="fill-[#35538F] hidden dark:block"
    />
    <path
      ...
      className="stroke-[#548AF7] hidden dark:block"
    />
  </svg>
);
