...
export type LockUltimateProps = Omit<ComponentProps<'svg'>, 'size'> & {
  size?: 12 | 14 | 16 | 20 | 24;
  mode?: 'light' | 'dark';
};

export const LockUltimate = ({
  size = 16,
  mode: _mode,
  className,
  ...
  >
    <path
      ...
      className="fill-[url(#paint0_linear_22834_4327)] dark:fill-[url(#paint0_linear_22834_4329)]"
    />
  </svg>
);
