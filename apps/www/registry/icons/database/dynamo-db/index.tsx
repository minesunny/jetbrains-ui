...
export type DynamoDbProps = Omit<ComponentProps<'svg'>, 'size'> & {
  size?: 12 | 14 | 16 | 20 | 24;
  mode?: 'light' | 'dark';
};
...
export const DynamoDb = ({
  ...
  >
    <path
      ...
      className="fill-[#5294CF]"
    />
    <path
      d="M6.196 14.976h-.172l-2.772-1.387-.056-.097-.029-10.984.085-.122L6.024 1h.174z"
      className="fill-[#1F5B98]"
    />
    <path d="M6.028 1h3.945v13.976H6.028z" className="fill-[#2D72B8]" />
    <path
