...
export type PinHoveredProps = Omit<ComponentProps<'svg'>, 'size'> & {
  size?: 12 | 14 | 16 | 20 | 24;
  mode?: 'light' | 'dark';
};

const PinHoveredLight: FC<
...
export const PinHovered: FC<PinHoveredProps> = ({
  size = 16,
  mode = 'light',
  className,
  'aria-label': ariaLabel,
  ...
  const SvgComponent = mode === 'light' ? PinHoveredLight : PinHoveredDark;
