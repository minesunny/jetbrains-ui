...
export type ThreadFrozenProps = Omit<ComponentProps<'svg'>, 'size'> & {
  size?: 12 | 14 | 16 | 20 | 24;
  mode?: 'light' | 'dark';
};

const ThreadFrozenLight: FC<
...
export const ThreadFrozen: FC<ThreadFrozenProps> = ({
  size = 16,
  mode = 'light',
  className,
  'aria-label': ariaLabel,
