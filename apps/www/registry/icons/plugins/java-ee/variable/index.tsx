...
export const JavaEeVariable = ({
  ...
  >
    ...
    />
    <path
      d="M8.372 11.4h-.826l-2.367-6h1.06l1.805 4.705L9.79 5.4h1.031L9.125 9.722q-.176.24-.32.51-.299.556-.433 1.168"
      className="fill-[#E66D17] dark:fill-[#C77D55]"
    />
  </svg>
);

export default JavaEeVariable;
