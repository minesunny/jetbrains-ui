...
export type InterfaceProps = SvgProps;

const InterfaceLight: React.FC<SvgProps> = ({
  size,
  className,
  role,
  ...
  >
    ...
    />
    <path
      d="M8.35 11.5H6v-1h1.5v-5H6v-1h4v1H8.5v5h.172q-.218.48-.321 1"
      fill="#208A3C"
    />
  </svg>
);

const InterfaceDark: React.FC<SvgProps> = ({
  size,
  className,
  role,
  'aria-label': ariaLabel,
