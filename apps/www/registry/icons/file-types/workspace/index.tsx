...
export type WorkspaceProps = SvgProps;

const WorkspaceLight: FC<SvgProps> = ({
  size,
  className,
  title,
  role,
...
const WorkspaceDark: FC<SvgProps> = ({
  size,
  className,
  title,
  role,
...
export const Workspace: FC<WorkspaceProps> = ({
  ...
  const SvgComponent = mode === 'light' ? WorkspaceLight : WorkspaceDark;
