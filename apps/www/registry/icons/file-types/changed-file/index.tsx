...
export type ChangedFileProps = Omit<ComponentProps<'svg'>, 'size'> & {
  size?: 12 | 14 | 16 | 20 | 24;
  mode?: 'light' | 'dark';
};

const ChangedFileLight: FC<
...
export const ChangedFile: FC<ChangedFileProps> = ({
  size = 16,
  mode = 'light',
  className,
  'aria-label': ariaLabel,
