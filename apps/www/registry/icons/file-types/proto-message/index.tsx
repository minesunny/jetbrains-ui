...
export type ProtoMessageProps = Omit<ComponentProps<'svg'>, 'size'> & {
  size?: 12 | 14 | 16 | 20 | 24;
  mode?: 'light' | 'dark';
};

const ProtoMessageLight: FC<
...
export const ProtoMessage: FC<ProtoMessageProps> = ({
  size = 16,
  mode = 'light',
  className,
  'aria-label': ariaLabel,
  ...
  const SvgComponent = mode === 'light' ? ProtoMessageLight : ProtoMessageDark;
