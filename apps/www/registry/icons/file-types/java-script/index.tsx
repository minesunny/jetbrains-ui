...
export type JavaScriptProps = Omit<ComponentProps<'svg'>, 'size'> & {
  size?: 12 | 14 | 16 | 20 | 24;
  mode?: 'light' | 'dark';
};

const JavaScriptLight: FC<
...
export const JavaScript: FC<JavaScriptProps> = ({
  size = 16,
  mode = 'light',
  className,
  'aria-label': ariaLabel,
  ...
  const SvgComponent = mode === 'light' ? JavaScriptLight : JavaScriptDark;
