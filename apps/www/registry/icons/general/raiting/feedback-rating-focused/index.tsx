...
export type FeedbackRatingFocusedProps = Omit<ComponentProps<'svg'>, 'size'> & {
  size?: 12 | 14 | 16 | 20 | 24;
  mode?: 'light' | 'dark';
};

export const FeedbackRatingFocused = ({
  size = 16,
  mode: _mode,
  className,
  'aria-label': ariaLabel,
  ...props
}: FeedbackRatingFocusedProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 32 32"
  ...
  >
    <path
      ...
      className="fill-[#A8ADBD] dark:fill-[#5A5D63]"
    />
  </svg>
);

export default FeedbackRatingFocused;
