...
export type ToolWindowRHtmlProps = Omit<ComponentProps<'svg'>, 'size'> & {
  size?: 12 | 14 | 16 | 20 | 24;
  mode?: 'light' | 'dark';
};

const ToolWindowRHtmlLight: FC<
...
export const ToolWindowRHtml: FC<ToolWindowRHtmlProps> = ({
  size = 16,
  mode = 'light',
  className,
  'aria-label': ariaLabel,
  ...
  const SvgComponent =
    mode === 'light' ? ToolWindowRHtmlLight : ToolWindowRHtmlDark;
