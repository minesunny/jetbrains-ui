...
export type ToolWindowRecordDebugProps = Omit<ComponentProps<'svg'>, 'size'> & {
  size?: 12 | 14 | 16 | 20 | 24;
  mode?: 'light' | 'dark';
};

export const ToolWindowRecordDebug = ({
  size = 16,
  mode: _mode,
  className,
  'aria-label': ariaLabel,
  ...props
}: ToolWindowRecordDebugProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 16 16"
  ...
  >
    <path
      d="M13 14a1 1 0 1 0 0-2 1 1 0 0 0 0 2"
...
export default ToolWindowRecordDebug;
