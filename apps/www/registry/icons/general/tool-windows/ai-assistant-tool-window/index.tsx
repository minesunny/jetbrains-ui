...
export type AiAssistantToolWindowProps = Omit<ComponentProps<'svg'>, 'size'> & {
  size?: 12 | 14 | 16 | 20 | 24;
  mode?: 'light' | 'dark';
};

const AiAssistantToolWindowLight: FC<
...
const AiAssistantToolWindowDark: FC<
  Omit<ComponentProps<'svg'>, 'size'> & { size: number }
> = ({
  size,
  className,
...
export const AiAssistantToolWindow: FC<AiAssistantToolWindowProps> = ({
  size = 16,
  mode = 'light',
  className,
  'aria-label': ariaLabel,
  ...
  const SvgComponent =
    mode === 'light' ? AiAssistantToolWindowLight : AiAssistantToolWindowDark;
...
export default AiAssistantToolWindow;
