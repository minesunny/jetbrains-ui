...
export type MessagesProps = Omit<ComponentProps<'svg'>, 'size'> & {
  size?: 12 | 14 | 16 | 20 | 24;
  mode?: 'light' | 'dark';
};

const MessagesLight: FC<
...
> = ({
  ...
  >
    <g clipPath="url(#a)" fill="#CED0D6">
      ...
      <rect x={2} y={9} width={10} height={1} rx={0.5} />
      <rect x={2} y={6} width={9} height={1} rx={0.5} />
