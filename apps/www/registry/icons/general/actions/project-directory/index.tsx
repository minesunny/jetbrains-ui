...
export type ProjectDirectoryProps = Omit<ComponentProps<'svg'>, 'size'> & {
  size?: 12 | 14 | 16 | 20 | 24;
  mode?: 'light' | 'dark';
};

const ProjectDirectoryLight: FC<
...
> = ({
  ...
  >
    ...
    />
    <path
      d="M2.633 2C1.731 2 1 2.836 1 3.867v8.266C1 13.164 1.731 14 2.633 14H8v-3a3 3 0 0 1 3-3h4V6a2 2 0 0 0-2-2H8.467L6.843 2.308A1 1 0 0 0 6.122 2z"
      fill="#EBECF0"
    />
    <path
...
export const ProjectDirectory: FC<ProjectDirectoryProps> = ({
  size = 16,
  mode = 'light',
  className,
  'aria-label': ariaLabel,
  ...
  const SvgComponent =
    mode === 'light' ? ProjectDirectoryLight : ProjectDirectoryDark;
