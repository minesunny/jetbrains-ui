...
export type ProfileRedProps = Omit<ComponentProps<'svg'>, 'size'> & {
  size?: 12 | 14 | 16 | 20 | 24;
  mode?: 'light' | 'dark';
};

const ProfileRedLight: FC<
...
> = ({
  ...
  >
    ...
    />
    <path
      d="M2 8a6 6 0 1 1 11.958.713l.923.577Q15 8.66 15 8a7 7 0 1 0-7 7v-1a6 6 0 0 1-6-6"
      fill="#6C707E"
    />
    <path
...
export const ProfileRed: FC<ProfileRedProps> = ({
  size = 16,
  mode = 'light',
  className,
  'aria-label': ariaLabel,
  ...
  const SvgComponent = mode === 'light' ? ProfileRedLight : ProfileRedDark;
