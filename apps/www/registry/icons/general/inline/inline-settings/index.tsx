...
export type InlineSettingsProps = Omit<ComponentProps<'svg'>, 'size'> & {
  size?: 12 | 14 | 16 | 20 | 24;
  mode?: 'light' | 'dark';
};

const InlineSettingsLight: FC<
...
export const InlineSettings: FC<InlineSettingsProps> = ({
  size = 16,
  mode = 'light',
  className,
  'aria-label': ariaLabel,
  ...
  const SvgComponent =
    mode === 'light' ? InlineSettingsLight : InlineSettingsDark;
