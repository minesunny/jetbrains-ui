...
export type SystemThemeSelectedProps = Omit<ComponentProps<'svg'>, 'size'> & {
  size?: 12 | 14 | 16 | 20 | 24;
  mode?: 'light' | 'dark';
};

const SystemThemeSelectedLight: FC<
...
const SystemThemeSelectedDark: FC<
  Omit<ComponentProps<'svg'>, 'size'> & { size: number }
> = ({
  size,
  className,
...
export const SystemThemeSelected: FC<SystemThemeSelectedProps> = ({
  ...
  const SvgComponent =
    mode === 'light' ? SystemThemeSelectedLight : SystemThemeSelectedDark;
...
export default SystemThemeSelected;
