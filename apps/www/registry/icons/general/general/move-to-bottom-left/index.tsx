...
export type MoveToBottomLeftProps = Omit<ComponentProps<'svg'>, 'size'> & {
  size?: 12 | 14 | 16 | 20 | 24;
  mode?: 'light' | 'dark';
};

const MoveToBottomLeftLight: FC<
...
export default MoveToBottomLeft;
