...
export type SortByUsageProps = Omit<ComponentProps<'svg'>, 'size'> & {
  size?: 12 | 14 | 16 | 20 | 24;
  mode?: 'light' | 'dark';
};

const SortByUsageLight: FC<
...
export const SortByUsage: FC<SortByUsageProps> = ({
  size = 16,
  mode = 'light',
  className,
  'aria-label': ariaLabel,
