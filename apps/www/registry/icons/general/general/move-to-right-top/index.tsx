...
export type MoveToRightTopProps = SvgProps;

const MoveToRightTopLight: FC<SvgProps> = ({
  size,
  className,
  title,
  role,
...
const MoveToRightTopDark: FC<SvgProps> = ({
  size,
  className,
  title,
  role,
...
export const MoveToRightTop: FC<MoveToRightTopProps> = ({
  size = 'md',
  mode = 'light',
  className,
  'aria-label': ariaLabel,
  ...
  const SvgComponent =
    mode === 'light' ? MoveToRightTopLight : MoveToRightTopDark;
