...
export type MoreVerticalProps = Omit<ComponentProps<'svg'>, 'size'> & {
  size?: 12 | 14 | 16 | 20 | 24;
  mode?: 'light' | 'dark';
};

const MoreVerticalLight: FC<
...
export const MoreVertical: FC<MoreVerticalProps> = ({
  size = 16,
  mode = 'light',
  className,
  'aria-label': ariaLabel,
