...
export type ChevronDownHoveredProps = IconProps;
...
export const ChevronDownHovered: FC<ChevronDownHoveredProps> = ({
  size = 'md',
  mode = 'light',
  className,
  'aria-label': ariaLabel,
  ...
  const SvgComponent =
    mode === 'light' ? ChevronDownHoveredLight : ChevronDownHoveredDark;
