...
export type AiAssistantColoredProps = Omit<ComponentProps<'svg'>, 'size'> & {
  size?: 12 | 14 | 16 | 20 | 24;
  mode?: 'light' | 'dark';
};

const AiAssistantColoredLight: FC<
...
const AiAssistantColoredDark: FC<
  Omit<ComponentProps<'svg'>, 'size'> & { size: number }
> = ({
  size,
  className,
...
export const AiAssistantColored: FC<AiAssistantColoredProps> = ({
  size = 16,
  mode = 'light',
  className,
  'aria-label': ariaLabel,
  ...
  const SvgComponent =
    mode === 'light' ? AiAssistantColoredLight : AiAssistantColoredDark;
...
export default AiAssistantColored;
