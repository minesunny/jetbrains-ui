...
export type AiAssistantProps = Omit<ComponentProps<'svg'>, 'size'> & {
  size?: 12 | 14 | 16 | 20 | 24;
  mode?: 'light' | 'dark';
};

const AiAssistantLight: FC<
...
export const AiAssistant: FC<AiAssistantProps> = ({
  ...
  const SvgComponent = mode === 'light' ? AiAssistantLight : AiAssistantDark;
