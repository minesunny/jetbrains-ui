...
export type GeneratedSourceProps = Omit<ComponentProps<'svg'>, 'size'> & {
  size?: 12 | 14 | 16 | 20 | 24;
  mode?: 'light' | 'dark';
};

const GeneratedSourceLight: FC<
...
export const GeneratedSource: FC<GeneratedSourceProps> = ({
  size = 16,
  mode = 'light',
  className,
  'aria-label': ariaLabel,
  ...
  const SvgComponent =
    mode === 'light' ? GeneratedSourceLight : GeneratedSourceDark;
...
export default GeneratedSource;
