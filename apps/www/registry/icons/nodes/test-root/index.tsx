...
export type TestRootProps = SvgProps;

const TestRootLight: FC<SvgProps> = ({
  size,
  className,
  title,
  role,
...
const TestRootDark: FC<SvgProps> = ({
  size,
  className,
  title,
  role,
...
export const TestRoot: FC<TestRootProps> = ({
  size = 'md',
  mode = 'light',
  className,
  'aria-label': ariaLabel,
  ...
  const SvgComponent = mode === 'light' ? TestRootLight : TestRootDark;
