...
export type ExcludeRootProps = Omit<ComponentProps<'svg'>, 'size'> & {
  size?: 12 | 14 | 16 | 20 | 24;
  mode?: 'light' | 'dark';
};

const ExcludeRootLight: FC<
...
export const ExcludeRoot: FC<ExcludeRootProps> = ({
  size = 16,
  mode = 'light',
  className,
  'aria-label': ariaLabel,
