...
export type StarEmptyProps = Omit<ComponentProps<'svg'>, 'size'> & {
  size?: 12 | 14 | 16 | 20 | 24;
  mode?: 'light' | 'dark';
};

const StarEmptyLight: FC<
...
export const StarEmpty: FC<StarEmptyProps> = ({
  size = 16,
  mode = 'light',
  className,
  'aria-label': ariaLabel,
  ...
  const SvgComponent = mode === 'light' ? StarEmptyLight : StarEmptyDark;
