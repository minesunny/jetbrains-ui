...
export type NewFolderProps = Omit<ComponentProps<'svg'>, 'size'> & {
  size?: 12 | 14 | 16 | 20 | 24;
  mode?: 'light' | 'dark';
};

const NewFolderLight: FC<
...
> = ({
  ...
  >
    ...
    />
    <path
      d="M2.633 2C1.731 2 1 2.836 1 3.867v8.266C1 13.164 1.731 14 2.633 14H8v-1.5A1.5 1.5 0 0 1 9.5 11H11V9.5A1.5 1.5 0 0 1 12.5 8H15V6a2 2 0 0 0-2-2H8.467L6.843 2.308A1 1 0 0 0 6.122 2z"
      fill="#EBECF0"
    />
    <path
...
export const NewFolder: FC<NewFolderProps> = ({
  ...
  const SvgComponent = mode === 'light' ? NewFolderLight : NewFolderDark;
