...
export type UnloadedModuleProps = Omit<ComponentProps<'svg'>, 'size'> & {
  size?: 12 | 14 | 16 | 20 | 24;
  mode?: 'light' | 'dark';
};

const UnloadedModuleLight: FC<
...
export const UnloadedModule: FC<UnloadedModuleProps> = ({
  size = 16,
  mode = 'light',
  className,
  'aria-label': ariaLabel,
  ...
  const SvgComponent =
    mode === 'light' ? UnloadedModuleLight : UnloadedModuleDark;
