...
export type GvariableProps = SvgProps;

const GvariableLight: FC<SvgProps> = ({
  size,
  className,
  role,
...
const GvariableDark: FC<SvgProps> = ({
  size,
  className,
  role,
  'aria-label': ariaLabel,
...
export const Gvariable: FC<GvariableProps> = ({
  size = 'md',
  mode = 'light',
  className,
  'aria-label': ariaLabel,
  ...
  const SvgComponent = mode === 'light' ? GvariableLight : GvariableDark;
