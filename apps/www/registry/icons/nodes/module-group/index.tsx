...
> = ({
  ...
  >
    ...
    <rect
      ...
      stroke="#3574F0"
    />
    <path fill="#3574F0" d="M12 10H13V16H12z" />
    <path fill="#3574F0" d="M10 12H15V13H10z" />
  </svg>
);

const ModuleGroupDark: FC<
  Omit<ComponentProps<'svg'>, 'size'> & { size: number }
> = ({
  size,
  className,
  ...
  >
    ...
    <rect
      ...
      stroke="#548AF7"
    />
    <path fill="#548AF7" d="M12 10H13V16H12z" />
    <path fill="#548AF7" d="M10 12H15V13H10z" />
  </svg>
);
