...
export type DataTablesProps = Omit<ComponentProps<'svg'>, 'size'> & {
  size?: 12 | 14 | 16 | 20 | 24;
  mode?: 'light' | 'dark';
};

const DataTablesLight: FC<
...
export const DataTables: FC<DataTablesProps> = ({
  ...
  const SvgComponent = mode === 'light' ? DataTablesLight : DataTablesDark;
