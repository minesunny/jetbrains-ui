...
export type ExcludedGeneratedProps = Omit<ComponentProps<'svg'>, 'size'> & {
  size?: 12 | 14 | 16 | 20 | 24;
  mode?: 'light' | 'dark';
};

const ExcludedGeneratedLight: FC<
...
const ExcludedGeneratedDark: FC<
  Omit<ComponentProps<'svg'>, 'size'> & { size: number }
> = ({
  size,
  className,
...
export const ExcludedGenerated: FC<ExcludedGeneratedProps> = ({
  size = 16,
  mode = 'light',
  className,
  'aria-label': ariaLabel,
  ...
  const SvgComponent =
    mode === 'light' ? ExcludedGeneratedLight : ExcludedGeneratedDark;
...
export default ExcludedGenerated;
