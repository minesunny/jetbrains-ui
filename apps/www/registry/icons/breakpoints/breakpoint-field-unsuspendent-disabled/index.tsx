...
export type BreakpointFieldUnsuspendentDisabledProps = Omit<
  ComponentProps<'svg'>,
  'size'
> & {
  size?: 12 | 14 | 16 | 20 | 24;
...
const BreakpointFieldUnsuspendentDisabledLight: FC<
...
const BreakpointFieldUnsuspendentDisabledDark: FC<
  Omit<ComponentProps<'svg'>, 'size'> & { size: number }
> = ({
  size,
  className,
