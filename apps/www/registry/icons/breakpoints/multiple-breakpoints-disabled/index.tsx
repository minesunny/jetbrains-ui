...
export type MultipleBreakpointsDisabledProps = Omit<
  ComponentProps<'svg'>,
  'size'
> & {
  size?: 12 | 14 | 16 | 20 | 24;
...
const MultipleBreakpointsDisabledLight: FC<
...
const MultipleBreakpointsDisabledDark: FC<
  Omit<ComponentProps<'svg'>, 'size'> & { size: number }
> = ({
  size,
  className,
...
export default MultipleBreakpointsDisabled;
