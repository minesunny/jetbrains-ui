...
export type BreakpointUnsuspendentDisabledProps = Omit<
  ComponentProps<'svg'>,
  'size'
> & {
  size?: 12 | 14 | 16 | 20 | 24;
...
const BreakpointUnsuspendentDisabledLight: FC<
...
const BreakpointUnsuspendentDisabledDark: FC<
  Omit<ComponentProps<'svg'>, 'size'> & { size: number }
> = ({
  size,
  className,
...
export default BreakpointUnsuspendentDisabled;
