...
export type BreakpointExceptionDisabledProps = Omit<
  ComponentProps<'svg'>,
  'size'
> & {
  size?: 12 | 14 | 16 | 20 | 24;
...
const BreakpointExceptionDisabledLight: FC<
...
const BreakpointExceptionDisabledDark: FC<
  Omit<ComponentProps<'svg'>, 'size'> & { size: number }
> = ({
  size,
  className,
...
export default BreakpointExceptionDisabled;
