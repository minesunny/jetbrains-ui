...
export type FailedInProgressProps = Omit<ComponentProps<'svg'>, 'size'> & {
  size?: 12 | 14 | 16 | 20 | 24;
  mode?: 'light' | 'dark';
};

export const FailedInProgress = ({
  size = 16,
  mode: _mode,
  className,
  'aria-label': ariaLabel,
  ...props
}: FailedInProgressProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 16 16"
  ...
  >
    <path
      ...
      className="fill-[#E55765] dark:fill-[#BD5757]"
    />
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      ...
      className="fill-[#E46A76] dark:fill-[#9C4E4E]"
    />
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      ...
      className="fill-[#ED99A1] dark:fill-[#7A4343]"
    />
    <path
      fillRule="evenodd"
      clipRule="evenodd"
...
export default FailedInProgress;
