...
export type ShowCurrentFrameProps = Omit<ComponentProps<'svg'>, 'size'> & {
  size?: 12 | 14 | 16 | 20 | 24;
  mode?: 'light' | 'dark';
};

const ShowCurrentFrameLight: FC<
...
export const ShowCurrentFrame: FC<ShowCurrentFrameProps> = ({
  size = 16,
  mode = 'light',
  className,
  'aria-label': ariaLabel,
  ...
  const SvgComponent =
    mode === 'light' ? ShowCurrentFrameLight : ShowCurrentFrameDark;
