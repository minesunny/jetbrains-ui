...
export type RunWithCoverageProps = Omit<ComponentProps<'svg'>, 'size'> & {
  size?: 12 | 14 | 16 | 20 | 24;
  mode?: 'light' | 'dark';
};

const RunWithCoverageLight: FC<
...
export const RunWithCoverage: FC<RunWithCoverageProps> = ({
  size = 16,
  mode = 'light',
  className,
  'aria-label': ariaLabel,
  ...
  const SvgComponent =
    mode === 'light' ? RunWithCoverageLight : RunWithCoverageDark;
...
export default RunWithCoverage;
