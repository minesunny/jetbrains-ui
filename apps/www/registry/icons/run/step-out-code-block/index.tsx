...
export type StepOutCodeBlockProps = Omit<ComponentProps<'svg'>, 'size'> & {
  size?: 12 | 14 | 16 | 20 | 24;
  mode?: 'light' | 'dark';
};

const StepOutCodeBlockLight: FC<
...
export default StepOutCodeBlock;
