...
> = ({
  ...
  <svg
    ...
    aria-hidden={ariaHidden}
  >
    <path d="M11.5 4.5v7h-7m4-10v7h-7" stroke="#6C707E" strokeLinecap="round" />
  </svg>
);
...
> = ({
  ...
  <svg
    ...
    aria-hidden={ariaHidden}
  >
    <path d="M11.5 4.5v7h-7m4-10v7h-7" stroke="#CED0D6" strokeLinecap="round" />
  </svg>
);
...
export const ArrowRightDown: FC<ArrowRightDownProps> = ({
  ...
  const SvgComponent =
    mode === 'light' ? ArrowRightDownLight : ArrowRightDownDark;
