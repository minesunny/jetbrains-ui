...
export type GutterCheckBoxIndeterminateProps = Omit<
  ComponentProps<'svg'>,
  'size'
> & {
  size?: 12 | 14 | 16 | 20 | 24;
...
const GutterCheckBoxIndeterminateLight: FC<
...
const GutterCheckBoxIndeterminateDark: FC<
  Omit<ComponentProps<'svg'>, 'size'> & { size: number }
> = ({
  size,
  className,
...
export default GutterCheckBoxIndeterminate;
